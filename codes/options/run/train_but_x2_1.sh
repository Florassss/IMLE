...
##SBATCH --nodelist=em8    # Uncomment if you need a specific machine.
...
# %j is jobid.
#SBATCH -o ./logs/slurm.train_hrim_but_x2_1.out    # STDOUT
...
# Do all the research.
python train_ms_one.py -opt options/train/train_butterfly_256to512.json
