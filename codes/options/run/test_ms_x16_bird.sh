...
#SBATCH --nodelist=em4    # Uncomment if you need a specific machine.
...
# %j is jobid.
#SBATCH -o ./logs/slurm.test_ms_x16_bird.out    # STDOUT
...
# Do all the research.
#python test_ms_pipline_three_one.py -opt options/test/test_ms_rrdb_18_x8.json -opts options/test/test_ms_rrdb_32_x2.json
python test_ms_pipline_three_one.py -opt options/test/test_ms_rrdb_25_x8.json -opts options/test/test_ms_rrdb_48_x2.json
